  ...
  fields: [
    {
      ...
      control: 'number',
      required: 'conditional',
      requiredWhen: [{ field: 'mode', op: 'eq', value: 'LCL' }],
      storage: 'details',
      unit: 'kg',
  ...
  fields: [
    {
      ...
      control: 'number',
      required: 'conditional',
      requiredWhen: [{ field: 'mode', op: 'eq', value: 'Air Freight' }],
      storage: 'details',
      unit: 'kg',
...
const FORWARDING_CORE_SECTION: QuotationSectionDef = {
  ...
  fields: [
    ...
    },
    {
      ...
      control: 'free-text',
      required: 'conditional',
      requiredWhen: [{ field: 'incoterms', op: 'in', value: INCOTERMS_WITH_COLLECTION_ADDRESS }],
      storage: 'details',
    ...
    },
    {
      ...
      control: 'free-text',
      required: 'conditional',
      requiredWhen: [{ field: 'incoterms', op: 'in', value: INCOTERMS_WITH_DELIVERY_ADDRESS }],
      storage: 'details',
