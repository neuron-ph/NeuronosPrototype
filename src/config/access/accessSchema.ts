    ...
    modules: [
      ...
      // prefix to avoid a permission-data migration; the prefix is internal.
      {
        ...
        tabs: [
          ...
          tab("ops_marine_insurance_attachments_tab", "Attachments"),
      ...
      },
      {
        ...
        tabs: [
          ...
          tab("pricing_others_attachments_tab", "Attachments"),
    ...
    modules: [
      {
        ...
        tabs: [
          ...
          tab("ops_forwarding_attachments_tab", "Attachments"),
      ...
      },
      {
        ...
        tabs: [
          ...
          tab("ops_brokerage_attachments_tab", "Attachments"),
      ...
      },
      {
        ...
        tabs: [
          ...
          tab("ops_trucking_attachments_tab", "Attachments"),
      ...
      },
      {
        ...
        tabs: [
          ...
          tab("ops_others_attachments_tab", "Attachments"),
