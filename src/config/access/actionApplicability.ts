...
export const APPLICABLE_ACTIONS: Record<ModuleId, readonly ActionId[]> = {
  ...
  pricing_contracts_quotation_tab: ["view", "edit"],
  ...
  bd_projects_quotation_tab: ["view", "edit"],
  ...
  pricing_projects_quotation_tab: ["view", "edit"],
  ...
  bd_contracts_quotation_tab: ["view", "edit"],
  ...
  ops_projects_quotation_tab: ["view", "edit"],
  ...
  acct_projects_quotation_tab: ["view", "edit"],
  ...
  acct_contracts_quotation_tab: ["view", "edit"],
