...
export const APPLICABLE_ACTIONS: Record<ModuleId, readonly ActionId[]> = {
  ...
  bd_contacts_activities_tab: ["view", "create", "edit", "delete"],
  bd_contacts_tasks_tab: ["view", "create", "edit", "delete"],
  ...
  pricing_contacts_activities_tab: ["view", "create", "edit", "delete"],
  pricing_contacts_tasks_tab: ["view", "create", "edit", "delete"],
