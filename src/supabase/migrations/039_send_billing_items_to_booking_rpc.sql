-- 039_send_billing_items_to_booking_rpc.sql
-- Trusted write path for linking project billings to a booking from the
-- project/pricing surface without relaxing the base billing_line_items RLS.
  ...
  LOOP
    ...
    IF v_is_virtual THEN
      ...
      VALUES (
        ...
        COALESCE(NULLIF(v_item->>'currency', ''), 'PHP'),
