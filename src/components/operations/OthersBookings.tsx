...
import { Plus, Search, Wrench, Briefcase, UserCheck, FileEdit, Clock, CheckCircle, Archive } from "lucide-react";
...
interface OthersDoorIds {
  ...
  detail: { financials: ModuleId; info: ModuleId; billings: ModuleId; invoices: ModuleId; collections: ModuleId; expenses: ModuleId; comments: ModuleId; chrono: ModuleId; attachments: ModuleId };
}
...
export const OTHERS_DOOR_IDS: Record<OthersDoor, OthersDoorIds> = {
  ops: {
    ...
    detail: { financials: "ops_others_financials_tab", info: "ops_others_info_tab", billings: "ops_others_billings_tab", invoices: "ops_others_invoices_tab", collections: "ops_others_collections_tab", expenses: "ops_others_expenses_tab", comments: "ops_others_comments_tab", chrono: "ops_others_chrono_tab", attachments: "ops_others_attachments_tab" },
  },
  pricing: {
    root: "pricing_others",
        ...
        <div style={{ padding: "32px 48px 24px 48px" }}>
          ...
          <div style={{ 
            ...
            >
              ...
              {getStatusOptions("Others").map((status) => (
