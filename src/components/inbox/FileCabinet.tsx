    ...
    entities: [
      {
        ...
        getLabel: (r: any) => r.booking_number || "—",
      ...
      },
      {
        ...
        getLabel: (r: any) => r.project_number || "—",
        getSublabel: (r: any) => r.customer_name || "",
    ...
    entities: [
      {
        ...
        getLabel: (r: any) => r.invoice_number || "—",
        getSublabel: (r: any) => r.customer_name || "",
      ...
      },
      {
        ...
        getLabel: (r: any) => r.collection_number || "—",
        getSublabel: (r: any) => r.customer_name || "",
      ...
      },
      {
        ...
        getLabel: (r: any) => r.evoucher_number || "—",
        getSublabel: (r: any) => r.customer_name || "",
