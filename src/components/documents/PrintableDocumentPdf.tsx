...
const s = StyleSheet.create({
  ...
  // NEU-085: invoice letterhead strip — centered banner at natural aspect
  // (cropped logo 1806x248 ≈ 7.28:1 → 393 x 54pt), horizontally centered.
  letterheadStripWrap: {
    alignItems: "center",
    marginBottom: 10,
  },
  ...
  return (
    <Document title={doc.title} author="Neuron OS">
      <Page size="A4" style={doc.brandedHeaderImage ? s.pageBranded : s.page}>
        {doc.brandedLetterheadImage ? (
          <>
            {/* NEU-085: invoice letterhead strip (clean centered banner) + ref bar */}
            <View style={s.letterheadStripWrap}>
              <Image src={doc.brandedLetterheadImage} style={s.letterheadStrip} />
            </View>
        ...
        {/* Page footer (ref · page numbers · "Generated by Neuron OS"). Hidden on
            invoices per Marcus — client-facing invoices shouldn't carry it.
            Invoices are the docs that set brandedLetterheadImage. */}
        {!doc.brandedLetterheadImage ? (
